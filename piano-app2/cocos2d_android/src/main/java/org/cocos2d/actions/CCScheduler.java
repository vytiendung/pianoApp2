    ...
    */
    public void tick(float dt) {
        ...
        for(ConcurrentArrayHashMap<Object, tHashSelectorEntry>.Entry e = hashForSelectors.firstValue();
            ...
            if(currentTarget!=null && ! currentTarget.paused && elt.timers != null) {
				...
				for (elt.timerIndex = 0; elt.timerIndex < elt.timers.size(); elt.timerIndex++) {
					...
					if (elt.currentTimerSalvaged) {
						// The currentTimer told the remove itself. To prevent
						// the timer from
						// accidentally deallocating itself before finishing its
						// step, we retained
            ...
            if(currentTarget!=null && currentTargetSalvaged && currentTarget.timers.isEmpty()) {
